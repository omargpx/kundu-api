...
import com.citse.kunduApp.exceptions.ApiError;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            var JWTError = new AuthJWTResponse(request.getRequestURI(),"The token has expired or is invalid", HttpStatus.UNAUTHORIZED.value());
